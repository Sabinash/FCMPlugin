...
FCMPlugin.prototype.getAllNotifications = function( success, error ){
	exec(success, error, "FCMPlugin", 'getAllNotifications', []);
}
FCMPlugin.prototype.markInboxMessageRead = function(messageId, success, error ){
	exec(success, error, "FCMPlugin", 'markInboxMessageRead', [messageId]);
}
FCMPlugin.prototype.clearNotificationByNotificationId = function(notificationId, success, error ){
	exec(success, error, "FCMPlugin", 'clearNotificationByNotificationId', [notificationId]);
}
