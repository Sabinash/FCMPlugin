...
public class FCMPlugin extends CordovaPlugin {
  ...
  private CallbackContext callback;
    ...
    this.callback = callbackContext;
          ...
          public void run() {
            try {
              ...
              for(Notifications mNotifications : mListnNotifications){
                ...
                mJsonObject.accumulate("title", mNotifications.getTitle());
                mJsonObject.accumulate("messagedate", mNotifications.getMessageDate());
                mJsonObject.accumulate("messageId", mNotifications.getMessageId());
      ...
      else if (action.equals("markInboxMessageRead")) {
        cordova.getThreadPool().execute(new Runnable() {
          public void run() {
            try {
      ...
      else if (action.equals("clearNotificationByNotificationId")) {
        cordova.getThreadPool().execute(new Runnable() {
          public void run() {
            try {
